...
public class Server {
	...
	public static Queue <Integer> ports; // static to be directly accessed by handler
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			if(!ports.isEmpty()) {
				...
				Handler handler = new Handler(port, filename, server.lossProbability, server.seedValue, clientPort, clientAddress);
				handler.start();
			} else {
